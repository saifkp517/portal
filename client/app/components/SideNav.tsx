...
export default function SideNav({ sendChangedComponent }: any) {
    ...
    const handleItemClick = (componentName: string) => {
        ...
        sendChangedComponent(componentName);
    }
    ...
    return (
        ...
        <div className="">
            <button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" className="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200  dark:hover:bg-gray-700 dark:focus:ring-gray-600">
                <span className="sr-only">Open sidebar</span>
                <svg onClick={toggleNav} className="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path clip-rule="evenodd" fill-rule="evenodd" d="M2 4.75A.75.75 0 012.75 4h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 4.75zm0 10.5a.75.75 0 01.75-.75h7.5a.75.75 0 010 1.5h-7.5a.75.75 0 01-.75-.75zM2 10a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 10z"></path>
                </svg>
            </button>

            <aside id="default-sidebar" className={`fixed top-0 left-0 z-40 w-64 h-screen transition-transform ${isOpen ? '-translate-x-full' : '-translate-x-0'} sm:translate-x-0`} aria-label="Sidebar">
                    ...
                    <ul className="space-y-2 font-medium">
                        <li onClick={toggleNav}>
                            <a href="#" className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group`}>
                                ...
                                <span className="ms-3">Dashboard <span className='text-green-500 text-xl font-bold'>PropertyVerse</span></span>
                            </a>
                        </li>
                        {/* <li>
              <a href="#" className={` ${activeComponent === 'upload' ? 'bg-gray-700 border border-blue-400' : ''} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group`}>
                ...
                <span className="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">Pro</span>
                        ...
                        {/* <li onClick={() => handleItemClick('users')}>
                            <a href="#" className={` ${activeComponent === 'users' ? 'bg-gray-700 border border-blue-400' : ''} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group`}>
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">Interested Users</span>
                                <span className="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">3</span>
                            </a>
                        </li> */}
                        <li onClick={() => handleItemClick('properties')}>
                            <a href="#" className={` ${activeComponent === 'properties' ? 'bg-gray-700 border border-blue-400' : ''} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group`}>
                        ...
                        <li>
                            <a href="/api/auth/logout" className={` ${activeComponent === 'logout' ? 'bg-gray-700 border border-blue-400' : ''} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group`}>
